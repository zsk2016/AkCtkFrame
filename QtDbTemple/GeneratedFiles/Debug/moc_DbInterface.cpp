...
const QMetaObject DbInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DbInterface.data,
      qt_meta_data_DbInterface,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DbInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DbInterface.stringdata0))
        return static_cast<void*>(const_cast< DbInterface*>(this));
    if (!strcmp(_clname, "ak::AkPluginOperateInterface"))
        return static_cast< ak::AkPluginOperateInterface*>(const_cast< DbInterface*>(this));
    if (!strcmp(_clname, "ak.AkPluginOperateInterface"))
        return static_cast< ak::AkPluginOperateInterface*>(const_cast< DbInterface*>(this));
