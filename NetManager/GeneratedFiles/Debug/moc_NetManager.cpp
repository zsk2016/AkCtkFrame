...
const QMetaObject NetManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NetManager.data,
      qt_meta_data_NetManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NetManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NetManager.stringdata0))
        return static_cast<void*>(const_cast< NetManager*>(this));
    if (!strcmp(_clname, "ak::AkPluginOperateInterface"))
        return static_cast< ak::AkPluginOperateInterface*>(const_cast< NetManager*>(this));
    if (!strcmp(_clname, "ak.AkPluginOperateInterface"))
        return static_cast< ak::AkPluginOperateInterface*>(const_cast< NetManager*>(this));
